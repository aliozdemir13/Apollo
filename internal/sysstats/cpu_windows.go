...
func sampleCPUPercent() (float64, bool) {
	idle1, kernel1, user1, ok1 := getSystemTimes()
	if !ok1 {
		return 0, false
	}
	...
	idle2, kernel2, user2, ok2 := getSystemTimes()
	if !ok2 {
		return 0, false
	}
